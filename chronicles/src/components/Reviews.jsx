...
useEffect(() => {
  const mockReviews = [
    ...
    { id: 4, name: "Sradha", rating: 4, comment: "amzing portraits and very unique." },
    { id: 5, name: "Mishal", rating: 5, comment: "Great photos and very professional." },
    { id: 6, name: "Amar", rating: 5, comment: "Good travel portraits." },
    { id: 7, name: "Amal", rating: 4, comment: "Great portraits and very professional." },
    { id: 8, name: "Akku", rating: 5, comment: "Catchy style portraits." }    
  ];
